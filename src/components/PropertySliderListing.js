              ...
              {module?.selectProperty.length > 0 &&
                module.selectProperty
                  ...
                  .map((item, i) => {
                    return (
                      <SwiperSlide key={i}>
                        <Link to={item.uri} className="cursor-pointer">
...
export const PagePropertySliderListingFragment = graphql`
  fragment PagePropertySliderListingFragment on WpPage_Pagecontent_PageContent_PropertySliderListing {
    extraId
    extraClass
    hideSection
    heading
