...
export const DestinationCallToActionFragment = graphql`
  fragment DestinationCallToActionFragment on WpDestination_Destinationcontent_DestinationContent_CallToAction {
    extraId
    extraClass
    hideSection
  }
`
export const OfferCallToActionFragment = graphql`
  fragment OfferCallToActionFragment on WpOffer_Offercontent_OfferContent_CallToAction {
    extraId
    extraClass
    hideSection
  }
